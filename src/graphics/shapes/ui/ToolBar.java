...
public class ToolBar extends JFrame {
    ...
    private JToolBar createToolBar(){
        ...
        JButton buttonCircle=new JButton(new ImageIcon("icons/circle.svg"));
        buttonCircle.setToolTipText("Forme: Cercle");
        toolBar.add(buttonCircle);

        JButton buttonSquare=new JButton(new ImageIcon("icons/circle.svg"));
        ...
        JButton buttonFree=new JButton(new ImageIcon("icons/new.png"));
        buttonFree.setToolTipText("Forme: Polygone Libre");
        toolBar.add(buttonFree);

        toolBar.addSeparator();

        JButton buttonErase=new JButton(new ImageIcon("icons/new.png"));
        buttonErase.setToolTipText("Gomme");
        toolBar.add(buttonErase);

        toolBar.addSeparator();

        JButton buttonPipette=new JButton(new ImageIcon("icons/new.png"));
        buttonPipette.setToolTipText("Pipette");
        toolBar.add(buttonPipette);

        JButton buttonColor=new JButton(new ImageIcon("icons/new.png")); //Afficher une page avec un choix de couleur
